...
if(ent->customgravity >= -1000 && ent->customgravity <= 1000 && ent->customgravityset)
  client->ps.gravity = ent->customgravity;
  ...
  if(ent->customspeed >= 1 && ent->customspeedset)
  client->ps.speed *= ent->customspeed;
